...
h4.author { font-size: 30px; }
p { font-size: 19px; line-height: 1.8; color: #333; }
...
a:hover, a:focus { background: #CBF8DF; }

p.tags { color: #6e6e73; }
```

<p class="tags">
Tags: [simtrial](#), [clinical trial simulation](#), [time-to-event](#)
</p>
...
To reproduce this, assuming you are using a clean library:

```{r, eval=FALSE}
options(repos = c("https://"))
install.packages("")
```

This will install the exact package versions.

Then render this R Markdown file.
